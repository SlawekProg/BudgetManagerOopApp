                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" method="POST">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div>
                                                <?php if (array_key_exists('expense_type', $errors)) : ?>
                                                    <div class="text-white">
                                                        <?php echo e($errors['expense_type'][0]); ?>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <div class="input-group">
                                                ...
                                                <select class="custom-select form-control border-start-0" name="payment_type">
                                                    ...
                                                    <?php foreach ($payments as $payment): ?>
                                                        <option value="<?= htmlspecialchars($payment['id']) ?>"
                                                            <?= (isset($oldFormData['payment_type']) && $oldFormData['payment_type'] == $payment['id']) ? 'selected' : '' ?>>
                                            ...
                                            <div>
                                                <?php if (array_key_exists('payment_type', $errors)) : ?>
                                                    <div class="text-white">
                                                        <?php echo e($errors['payment_type'][0]); ?>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-center mt-5 mb-lg-4">
                                            <button
                                                type="submit"
                                                class="btn btn-primary btn-lg">Dodaj</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
